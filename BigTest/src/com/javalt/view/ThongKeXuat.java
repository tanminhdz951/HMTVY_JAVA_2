...
public class ThongKeXuat extends javax.swing.JFrame {
    userService_thongkexuat userservice, dt;
    DefaultTableModel dtm, dtm_CTPX;
    User_thongkexuat user;
    public ThongKeXuat() {
        initComponents();
        
        userservice = new userService_thongkexuat();
        user = new User_thongkexuat();
    ...
    private void setTableData(List<User_thongkexuat> users) {
        for (User_thongkexuat user : users) {
            dtm.addRow(new Object[]{user.getMaPX(), user.getNgayXuat(), user.getLyDo(), user.getTenNV(),user.getTenKH(),user.getDiaChi()});
        }
    }
    public void setTableData_CTPX(List<User_thongkexuat> users) {
        for (User_thongkexuat user : users) {
