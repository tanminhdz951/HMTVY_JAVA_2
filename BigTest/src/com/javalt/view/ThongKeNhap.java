...
public class ThongKeNhap extends javax.swing.JFrame {
    userService_thongkeNhap userservice, dt;
    DefaultTableModel dtm, dtm_CTPN;
    User_thongkenhap user;
    
    
    public ThongKeNhap() {
        initComponents();
        userservice = new userService_thongkeNhap();
         user = new User_thongkenhap();
        ...
        dtm.addColumn("maPN");
        dtm.addColumn("ngayNhap");
        dtm.addColumn("maNV1");
        dtm.addColumn("tenNV1");
        dtm.addColumn("maNV1");
        dtm.addColumn("tenNV2");
        ...
        dtm_CTPN.addColumn("maPN");
        dtm_CTPN.addColumn("maSP");
        dtm_CTPN.addColumn("tenSP");
        dtm_CTPN.addColumn("soLuongDat");
        dtm_CTPN.addColumn("donGiaban");
    ...
    private void setTableData(List<User_thongkenhap> users) {
        for (User_thongkenhap user : users) {
            dtm.addRow(new Object[]{user.getMaPN(), user.getNgayNhap(), user.getMaNV1(),user.getTenNV1(),user.getMaNV2(),user.getTenNV2() });
        }
    }
    
    public void setTableData_CTDH(List<User_thongkenhap> users) {
        for (User_thongkenhap user : users) {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ttt, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
